...
Provides a graphical interface for enrolling face biometrics.
"""
...
class EnrollmentGUI:
    ...
    def setup_layout(self):
        ...
        # Option buttons
        self.enroll_face_btn = tk.Button(left_panel, text="Enroll Face",
...
2. Click "Enroll Face" to start face enrollment
3. Follow the on-screen instructions during enrollment
4. The camera preview will show your face during enrollment
        """
    ...
    def load_users(self):
        ...
        for user in users:
            ...
            display_text = f"{name} ({employee_id}) - Face: {face_status}"
